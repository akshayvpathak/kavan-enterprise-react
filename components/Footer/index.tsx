    ...
    <footer className=" border-stroke bg-primary ">
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
            ...
            >
              ...
              <p className="mb-10 mt-5 text-white">
                {" "}
                Discover the epitome of Diyas, futuristic Diya making machines,
                and exquisite Ceramic delights. Revolutionize your Festivities
                now!
              </p>
            ...
            <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-1/2 xl:w-1/2">
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-1/2 xl:w-1/2">
                <motion.div
                  ...
                  className="animate_top"
                >
                  <h4 className="mb-5 text-itemtitle2 font-medium text-white">
                    Ceramic Products
                  </h4>
        ...
        <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
          ...
          >
            <p className="text-white">
              &copy; {new Date().getFullYear()} Kavan Enterprise. All rights
              reserved
            </p>
          </motion.div>
